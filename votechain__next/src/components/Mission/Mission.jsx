    ...
    <div className="mission-container" id="mission">
      <div className="mission-details">
        ...
        <div className="mission-text">
          <h5>Our mission</h5>
          <p>
            The goal and the plan of the team is to show the power of blockchain
            and decentralization using some tools like the ChainLink Automation
          ...
          <div className="highlight-missions">
            <img src={"/images/Check icon.png"} alt="Check Icon" />
            <p>Allow users and electorate have a free and fair voting process</p>
          </div>
        </div>
      </div>
    </div>
