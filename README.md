...
Imagine a Decentralized voting system, secured, stress free, transparent for Citizens, winners are not selected by a body, but selected based on the number of votes verified by the Smart contract and announced automatically with ChainLink Automation, yes that’s Votechain.
